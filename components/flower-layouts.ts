...
const scatter: FlowerPlacement[] = [
  { left: "3%", top: "14%", size: 4.5, rotate: -8 },
  { left: "87%", top: "9%", size: 5, rotate: 12, hideOnMobile: true },
  { left: "78%", top: "60%", size: 4, rotate: 20 },
  { left: "8%", top: "70%", size: 5.5, rotate: -14, hideOnMobile: true },
  { left: "92%", top: "38%", size: 3.5, rotate: 6 },
  { left: "1%", top: "44%", size: 3.5, rotate: -22, hideOnMobile: true },
  { left: "63%", top: "15%", size: 3, rotate: 30, hideOnMobile: true },
  { left: "30%", top: "84%", size: 4, rotate: -6 },
];
